...
(function($) {
    ...
    var layoutManager = {
        ...
        loadBlock: function(item, setting) {
            ...
            // fix for bad size choice
            var noReduce = parseInt($item.attr('data-noReduce'));
            ...
            // fix for bad size choice
            var makeRound = (!fixSize && !noReduce) ? "round" : "ceil";
            // store original size;
        ...
        showBlock: function(item, setting) {
            ...
            var trans = start ? "width 0.5s, height 0.5s" : "top 0.5s, left 0.5s, width 0.15s, height 0.15s, opacity 0.5s";
            ...
            for (var b = 0; b < bigLoop; ++b) {
                ...
                for (var s = 0; s < smallLoop; ++s) {
                    ...
                    if (runtime.keepOrder) {
                        ...
                        block.resize = true;
                        if (items[0]) {
                            block.resize = ((maxX - freeArea.left) <= items[0].width);
                        }
                    } else {
