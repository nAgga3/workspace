...
(function(){helper.dom.ready(function(){var span=document.querySelector(".hiddenThin");if(span)span.innerHTML=window.productName+" v"+Thinfinity.global.variables.version+".";var panelInfo=document.getElementById("pInfo");if(panelInfo){helper.style.addCSSRule("table tbody tr:nth-child(even)","background-color:#ededed;");helper.style.addCSSRule("table tbody tr:nth-child(odd)","background-color:#ffffff;");function createTable(title){var table=helper.dom.createJsonElement({"type":"table","attributes":{"style":"border:1px solid #85a2b4;background-color:#3297d6;margin-left:10px;",
"cellSpacing":"0"}});var thead=helper.dom.appendJsonElement({"type":"thead","parentElement":table});var tr=helper.dom.appendJsonElement({"type":"tr","parentElement":thead,"attributes":{"style":"color:#ffffff;font-weight:400;font-size:11pt;text-align:left;height:20px;"}});if(title&&title!="")title=" ("+title+")";else title="";var td=helper.dom.appendJsonElement({"type":"td","parentElement":tr,"content":"Name"+title});var td=helper.dom.appendJsonElement({"type":"td","parentElement":tr,"content":"Value"});
var tbody=helper.dom.appendJsonElement({"type":"tbody","parentElement":table});return{"table":table,"tbody":tbody}}function appendRow(name,value,parentElem){var tr=helper.dom.appendJsonElement({"type":"tr","parentElement":parentElem,"attributes":{"style":"padding:5px;height:14px;"}});var td=helper.dom.appendJsonElement({"type":"td","parentElement":tr,"content":name,"attributes":{"style":"padding-left:5px;padding-right:5px;width:250px;"}});var td=helper.dom.appendJsonElement({"type":"td","parentElement":tr,
"content":value,"attributes":{"style":"padding-left:5px;padding-right:5px;min-width:120px;"}});return tr}function printVariables(ar,obj,parentElem){ar.forEach(function(attrib){if(typeof obj[attrib]==="object")for(var attr in obj[attrib]){if(typeof obj[attrib][attr]!="undefined"&&typeof obj[attrib][attr]!=="function"&&obj[attrib][attr]!=null)appendRow(attrib+"."+attr,obj[attrib][attr],parentElem)}else appendRow(attrib,obj[attrib],parentElem)})}var t=createTable("environment");var variables=["currentOrientation",
"currentDevicePixelRatio","initialDevicePixelRatio","detectedWidth","detectedHeight","availWidth","availHeight","rawWidth","rawHeight","width","height","currentWidth","currentHeight","viewportWidth","viewportHeight","devicePixelRatio","scaleAndLayout","resolutionMode","supportsFullScreen","isFullscreen","fullScreenAvailable","xZoom"];printVariables(variables,environment,t.tbody);panelInfo.appendChild(t.table);var t=createTable("screen");variables=["availWidth","availHeight","availTop","colorDepth",
"width","height","orientation"];printVariables(variables,screen,t.tbody);panelInfo.appendChild(t.table);var t=createTable("agent info");variables=["isMobile","isTouch","isWindows","isMac","isWindowsPhone","isChrome","chromeVersion","isFirefox","firefoxVersion","isMSIE","msieOSVersion","msieVersion","isSafari","isOpera","isIpod","isIphone","isIOS",,"ipadModel","iosVersion","iosBuildVersion","isChromium","isChromeOS","isAndroid","chromeOSVersion","isTabletMode","isSymbian","isYandex","isHPTablet","isDragon",
"dragonVersion","protocol","supportsRFXDecoder","supportsAsmJsWorkers","supportHTML5","hasWorkers","hasTypedArrays","hasTransferableObjects","hasObjectURL","hasArrayBuffers","agentStr"];printVariables(variables,agentInfo,t.tbody);panelInfo.appendChild(t.table);var t=createTable("navigator");variables=["appCodeName","appName","appVersion","language","maxTouchPoints","platform","product","productSub","vendor","userAgent"];printVariables(variables,navigator,t.tbody);panelInfo.appendChild(t.table)}})})();
